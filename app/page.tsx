    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-8 mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Link href="/topics" className="bg-white rounded-lg p-6 shadow hover:shadow-lg transition-shadow">
          ...
          <Link href="/errors" className="bg-white rounded-lg p-6 shadow hover:shadow-lg transition-shadow">
          ...
          <Link href="/search" className="bg-white rounded-lg p-6 shadow hover:shadow-lg transition-shadow">
